...
IDirect3DStateBlock9* actual_working_state = NULL;
...
void ImGui_ImplDX9_RenderDrawData(ImDrawData* draw_data)
{
    ...
    if (actual_working_state == NULL)
        g_pd3dDevice->CreateStateBlock(D3DSBT_ALL, &actual_working_state);
    else
        actual_working_state->Apply();
